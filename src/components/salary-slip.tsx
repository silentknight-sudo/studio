      ...
      <Card className="w-full border-2 border-primary shadow-2xl">
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="flex justify-between border-b py-2">
                ...
                <span>{grossSalary.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR</span>
              </div>
            ...
            <div>
              ...
              <div className="flex justify-between border-b py-2">
                ...
                <span>{advanceDeduction.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR</span>
              </div>
              <div className="flex justify-between font-bold pt-2">
          ...
          <div className="mt-6 rounded-lg bg-primary/5 p-4 text-center">
            ...
            <p className="font-headline text-3xl font-bold text-primary">{netPayableSalary.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} INR</p>
          </div>
